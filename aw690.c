...
/*
Reading in your polynomial and its limits
*/
...
/*
Menu to select how you want to integrate and then calls functions relating to your choice
*/
...
/*
Function containing the user inputted equation and allows its terms to be calculated
*/
float equation(float* order_array, float array_x, int delta)
{
    float f;
...
/*
Working out each x term then calling equation function to get your y terms
*/
...
Exact solution is 77.333 - could not work out what was wrong when calculating my y values, suspect issues with y0 and yFinal values
...
Exact solution is 168 - could not work out what was wrong when calculating my y values, suspect issues with y0 and yFinal values
*/
